...
def plot_metrics(metrics_file, output_path, output_file):
...
def main():
    ...
    test_metrics_file = compute_metrics(
            args.config,
            args.ckpt, 
            args.vae_ckpt,
            args.dataset, 
    ...
    train_metrics_file = compute_metrics(
            args.config,
            args.ckpt, 
            args.vae_ckpt,
            args.dataset, 
    ...
    plot_metrics(train_metrics_file, args.output_path, 'train')
    plot_metrics(test_metrics_file, args.output_path, 'test')
